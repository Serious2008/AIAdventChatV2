        ...
        if conversationMode == .collectingRequirements {
            ...
            if hasSimulatorTools {
                toolsDescription += """
                    ...
                    - Получать список установленных приложений (list_apps)

                    Когда пользователь просит что-то сделать с симулятором (запустить, сделать скриншот, установить приложение и т.д.), ВСЕГДА используйте соответствующие инструменты.
                    """
            }
